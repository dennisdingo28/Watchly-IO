...
export const Plan = ({plan}:{plan: PlanType}) =>{
    return (
        <div className="relative w-full bg-white cursor-pointer rounded-md p-2 shadow-[0px_0px_4px_rgb(119,109,242)] hover:shadow-[0px_0px_10px_rgb(119,109,242)] duration-150 hover:scale-105">
